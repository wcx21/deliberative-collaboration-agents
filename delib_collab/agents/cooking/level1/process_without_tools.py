...
from delib_collab.agents.cooking.level1.schemas import ObseverFormat, ThinkingFormat, DecisionProcessFormat, \
    MessageFormat
from delib_collab.prompts.cooking.level1.without_tools import OBSERVE_PROMPT, THINK_PROMPT, DECISION_PROMPT, TALK_PROMPT
...
if __name__ == '__main__':
    ...
    process_level_1_v0 = ProcessLevel1V1(
                game, LLM_model_name=model, max_conversation_rounds=max_round, max_character=max_character,
                log_folder=os.path.join(exp_name, 'level_1_no_tools'), log_name='v1', game_id=0,
